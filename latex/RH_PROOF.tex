...
\begin{itemize}
    ...
    \item A collision pair (off-critical) adds 2 to $\Delta N$ but 0 to $\Delta S$ and only 1 to $\Delta R_{\text{indented}}$
    \item The exact formula $\Delta N = \Delta f + \Delta S + \Delta R_{\text{indented}}$ gives $2 = 0 + 0 + 1$: contradiction
\end{itemize}
